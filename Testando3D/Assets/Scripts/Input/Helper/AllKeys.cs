...
namespace Assets.Scripts.Input.Helper
{
    ...
    public static class GamePadKey
    {
        ...
        public static Key rightStickX { get { return new Key { Name = "rightStick", Type = typeof(StickControl), Bit = 0 }; } }
        public static Key rightStickY { get { return new Key { Name = "rightStick", Type = typeof(StickControl), Bit = 1 }; } }
        public static Key leftStickX { get { return new Key { Name = "leftStick", Type = typeof(StickControl), Bit = 0 }; } }
        public static Key leftStickY { get { return new Key { Name = "leftStick", Type = typeof(StickControl), Bit = 1 }; } }
